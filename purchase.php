...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) {
    ...
    foreach ($_SESSION['cart'] as $isbn => $qty) {
        ...
        if ($book) {
            $inserted = insertOrderItem($order_id, $isbn, $book['book_price'], $qty);
            if (!$inserted) {
                ...
                <div class="card-body">
                    <form id="purchaseForm" method="POST" action="purchase.php" onsubmit="return validateForm()">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" Contact="contact" id="contact" class="form-control rounded-0" required pattern="^\d{10}$" title="Please enter a valid 10-digit contact number.">
                        </div>
                        <div class="form-group mb-3">
                            <label for="address">Address</label>
                            <textarea address ="address" id="address" class="form-control rounded-0" rows="3" required></textarea>
                        </div>
                        <div class="form-group mb-3">

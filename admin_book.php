...
<?php if (isset($_SESSION['book_success'])): ?>
    ...
    <?php unset($_SESSION['book_success']); endif; ?>
                ...
                <tbody>
                    <?php while($row = mysqli_fetch_assoc($result)) { ?>
                        <tr>
                            ...
                            <td class="px-2 py-1 align-middle">
                                <img src="images/<?php echo $row['book_image']; ?>" alt="Book Image" width="50">
                            </td>
                            <td class="px-2 py-1 align-middle">
                            ...
                            <td class="px-2 py-1 align-middle text-center">
                                <div class="btn-group btn-group-sm">
                                    ...
                                    <a href="admin_delete.php?bookisbn=<?php echo $row['book_isbn']; ?>" class="btn btn-sm rounded-0 btn-danger" title="Delete" 
                                       onclick="if(confirm('Are you sure to delete this book?') === false) event.preventDefault()">

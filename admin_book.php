                    ...
                    <?php while ($row = mysqli_fetch_assoc($result)): ?>  <!-- Correct usage of mysqli_fetch_assoc() -->
                        <tr>
                            ...
                            <td class="px-2 py-1 align-middle">
                                <img src="path_to_images/<?php echo $row['book_image']; ?>" alt="<?php echo $row['book_title']; ?>" style="width: 50px; height: auto;">
                            </td>
                            <td class="px-2 py-1 align-middle">
                                <p class="text-truncate" style="width:15em">
                                    <?php echo substr($row['book_descr'], 0, 100) . (strlen($row['book_descr']) > 100 ? '...' : ''); ?>
                                </p>
                            </td>

<?php
	...
	$query = "
		SELECT publishers.publisher_id, publishers.publisher_name, COUNT(books.publisherid) AS book_count 
		FROM publishers
		LEFT JOIN books ON publishers.publisher_id = books.publisherid
		GROUP BY publishers.publisher_id
		ORDER BY publishers.publisher_id
	";
...
?>
	...
	?>
		<a class="list-group-item list-group-item-action" href="bookPerPub.php?pubid=<?php echo $row['publisher_id']; ?>">
